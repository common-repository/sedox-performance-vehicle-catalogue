...
namespace SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7;

use SedoxWPCatalogue\Dependencies\Psr\Http\Message\RequestInterface;
use SedoxWPCatalogue\Dependencies\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `SedoxWPCatalogue\Dependencies\Psr\Http\Message\StreamInterface`: Returns the value as-is.
