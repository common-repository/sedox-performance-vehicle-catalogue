...
namespace SedoxWPCatalogue\Dependencies\Symfony\Polyfill\Intl\Idn;

use SedoxWPCatalogue\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use SedoxWPCatalogue\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!\SDXWPC_SDXWPC_Normalizer::isNormalized($domain, \SDXWPC_SDXWPC_Normalizer::FORM_C)) {
            $domain = \SDXWPC_SDXWPC_Normalizer::normalize($domain, \SDXWPC_SDXWPC_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!\SDXWPC_SDXWPC_Normalizer::isNormalized($label, \SDXWPC_SDXWPC_Normalizer::FORM_C)) {
