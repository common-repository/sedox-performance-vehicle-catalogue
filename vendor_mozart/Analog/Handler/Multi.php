 ...
 * Usage:
 *
 *		Analog::handler( SedoxWPCatalogue\Dependencies\Analog\Handler\Multi::init( array(
 *			// anything error or worse goes to this
 *			Analog::ERROR => array(
 *				SedoxWPCatalogue\Dependencies\Analog\Handler\Mail::init( $to, $subject, $from ),
 *				SedoxWPCatalogue\Dependencies\Analog\Handler\Stderr::init()
 *			),
 *
 *			// Warnings are sent here
 *			Analog::WARNING => SedoxWPCatalogue\Dependencies\Analog\Handler\File::init( 'logs/warnings.log' ),
 *
 *			// Debug and info messages sent here
 *			Analog::DEBUG   => SedoxWPCatalogue\Dependencies\Analog\Handler\Ignore::init() // do nothing
 *		) ) );
 *     
 *     // will be ignored
