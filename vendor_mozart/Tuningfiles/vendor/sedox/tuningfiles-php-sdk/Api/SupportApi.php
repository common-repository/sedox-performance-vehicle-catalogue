...
class SupportApi
{
     ...
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\InlineResponse201
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function supportCloseTicketWithHttpInfo($ticket_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\InlineResponse201';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\InlineResponse201',
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessages[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessages[], HTTP status code, HTTP response headers (array of strings)
     */
    public function supportCreateMessageWithHttpInfo($message, $display_name, $display_email, $attachments, $ticket_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessages[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessages[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportDepartments[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportDepartments[], HTTP status code, HTTP response headers (array of strings)
     */
    public function supportListDepartmentsWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportDepartments[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportDepartments[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTickets
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTickets, HTTP status code, HTTP response headers (array of strings)
     */
    public function supportListTicketsWithHttpInfo($per_page = '20', $page = null, $start_date = null, $end_date = null, $filter = null)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTickets';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTickets',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
