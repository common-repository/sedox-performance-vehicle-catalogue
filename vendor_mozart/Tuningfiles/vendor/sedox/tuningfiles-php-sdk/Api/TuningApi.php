...
namespace SedoxWPCatalogue\Dependencies\Tuningfiles\Api;

use SedoxWPCatalogue\Dependencies\GuzzleHttp\Client;
use SedoxWPCatalogue\Dependencies\GuzzleHttp\ClientInterface;
use SedoxWPCatalogue\Dependencies\GuzzleHttp\Exception\RequestException;
use SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\MultipartStream;
use SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\Request;
use SedoxWPCatalogue\Dependencies\GuzzleHttp\RequestOptions;
use SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException;
use SedoxWPCatalogue\Dependencies\Tuningfiles\Configuration;
use SedoxWPCatalogue\Dependencies\Tuningfiles\HeaderSelector;
...
class TuningApi
{
     ...
     *
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\AttachmentsUpload
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\AttachmentsUpload, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachmentUploadWithHttpInfo($file = null)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\AttachmentsUpload';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\AttachmentsUpload',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ErrorBadRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ErrorInvalidKey',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Error500',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\Request
     */
    protected function attachmentUploadRequest($file = null)
    {
        ...
        if ($file !== null) {
            $multipart = true;
            $formParams['file'] = \SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\try_fopen(ObjectSerializer::toFormValue($file), 'rb');
        }
        // body params
        $_tempBody = null;
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \SedoxWPCatalogue\Dependencies\GuzzleHttp\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \SedoxWPCatalogue\Dependencies\GuzzleHttp\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\build_query($formParams);
            }
        }
        ...
        $query = \SedoxWPCatalogue\Dependencies\GuzzleHttp\Psr7\build_query($queryParams);
        return new Request(
            'POST',
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\CreditsAmount
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\CreditsAmount, HTTP status code, HTTP response headers (array of strings)
     */
    public function creditsAmountWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\CreditsAmount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\CreditsAmount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\DownloadFile
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\DownloadFile, HTTP status code, HTTP response headers (array of strings)
     */
    public function fileDownloadWithHttpInfo($file_id, $project_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\DownloadFile';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\DownloadFile',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Error404',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesPurchase
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesPurchase, HTTP status code, HTTP response headers (array of strings)
     */
    public function filePurchaseWithHttpInfo($file_id, $project_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesPurchase';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesPurchase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesUpload
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesUpload, HTTP status code, HTTP response headers (array of strings)
     */
    public function fileUploadWithHttpInfo($file = null)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesUpload';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\FilesUpload',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\NotificationChannel[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\NotificationChannel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function notificationChannelsListWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\NotificationChannel[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\NotificationChannel[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Project
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Project, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectViewWithHttpInfo($project_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Project';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Project',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Projects
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Projects, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Projects';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Projects',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleReadTool[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleReadTool[], HTTP status code, HTTP response headers (array of strings)
     */
    public function readToolsListWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleReadTool[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleReadTool[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Remap[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Remap[], HTTP status code, HTTP response headers (array of strings)
     */
    public function remapsListWithHttpInfo($vehicle_type_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Remap[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Remap[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Subscription
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function tuningSubscriptionWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Subscription';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\Subscription',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleEngine[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleEngine[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesEnginesListWithHttpInfo($generation_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleEngine[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleEngine[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleGeneration[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleGeneration[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesGenerationsListWithHttpInfo($model_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleGeneration[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleGeneration[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleManufacturer[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleManufacturer[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesManufacturersListWithHttpInfo($vehicle_type_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleManufacturer[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleManufacturer[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleModel[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesModelsListWithHttpInfo($manufacturer_id)
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleModel[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleModel[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleTransmission[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleTransmission[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesTransmissionsListWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleTransmission[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleTransmission[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleType[]
     */
     ...
     * @throws \SedoxWPCatalogue\Dependencies\Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function vehiclesTypesListWithHttpInfo()
    {
        $returnType = '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleType[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VehicleType[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
