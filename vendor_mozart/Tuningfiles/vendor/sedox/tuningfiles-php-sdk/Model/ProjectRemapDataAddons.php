...
/**
 * ProjectRemapDataAddons Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProjectRemapDataAddons implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'project_remap_data_addons';
...
'tier_price' => 'getTierPrice'    ];
     ...
     * Sets tier_price
     *
     * @param bool $tier_price tier_price
     *
     * @return $this
     */
