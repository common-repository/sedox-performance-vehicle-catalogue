...
/**
 * SupportTicketMessagesAttachments Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportTicketMessagesAttachments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'support_ticket_messages_attachments';
...
'download_url' => 'getDownloadUrl'    ];
     ...
     * Sets id
     *
     * @param string $id Attachment ID. Can be integer if attachment is a file from a project.
     *
     * @return $this
     */
     ...
     * Sets download_url
     *
     * @param string $download_url Link to directly download the file
     *
     * @return $this
     */
