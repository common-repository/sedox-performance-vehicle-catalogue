...
/**
 * VdbEngineInfoOptions Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VdbEngineInfoOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vdb_engine_info_options';
...
'icon' => 'getIcon'    ];
     ...
     * Sets code
     *
     * @param string $code Option short name.
     *
     * @return $this
     */
     ...
     * Sets icon
     *
     * @param string $icon Link to the icon for this option.
     *
     * @return $this
     */
