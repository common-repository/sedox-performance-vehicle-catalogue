 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemapAddon implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'remap_addon';
...
'tier_price' => 'getTierPrice'    ];
     ...
     * Sets id
     *
     * @param int $id ID of the addon. When creating a tuning project, you may supply this id.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code This code is added into the file name (eg. Audi A4 .... DPF OFF, EGR OFF...mod)
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param int $price Price for the addon
     *
     * @return $this
     */
