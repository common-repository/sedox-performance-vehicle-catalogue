...
/**
 * SupportDepartments Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportDepartments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'support_departments';
...
'require_project' => 'setRequireProject'    ];
...
'require_project' => 'getRequireProject'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['require_project'] = isset($data['require_project']) ? $data['require_project'] : null;
    }
     ...
     * Sets title
     *
     * @param string $title Department Name
     *
     * @return $this
     */
     ...
     * Sets is_default
     *
     * @param bool $is_default Shows if this is the default department
     *
     * @return $this
     */
    ...
    /**
     * Gets require_project
     *
     * @return bool
     */
    public function getRequireProject()
    {
        return $this->container['require_project'];
    }

    /**
     * Sets require_project
     *
     * @param bool $require_project Shows if this department requires Project ID to be specified
     *
     * @return $this
     */
    public function setRequireProject($require_project)
    {
        $this->container['require_project'] = $require_project;
