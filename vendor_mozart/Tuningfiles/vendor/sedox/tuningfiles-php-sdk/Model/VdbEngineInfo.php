...
/**
 * VdbEngineInfo Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VdbEngineInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vdb_engine_info';
...
'engine_code' => 'string',
'fuel_name' => 'string',
'options' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoOptions[]',
'remap_stages' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoRemapStages[]',
'read_tools' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadTools[]',
'read_methods' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadMethods[]'    ];
...
'read_methods' => 'getReadMethods'    ];
     ...
     * Gets options
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoOptions[]
     */
     ...
     * Sets options
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoOptions[] $options Available remap options for this engine. This is only informational. When creating a project for tuning you should use the `addons` from [/vehicles/remaps/{vehicle_type_id}](#operation/remaps_list) method.
     *
     * @return $this
     */
     ...
     * Gets remap_stages
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoRemapStages[]
     */
    public function getRemapStages()
    {
        return $this->container['remap_stages'];
    }

    /**
     * Sets remap_stages
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoRemapStages[] $remap_stages Available remaps for this engine.
     *
     * @return $this
     */
    public function setRemapStages($remap_stages)
    {
        $this->container['remap_stages'] = $remap_stages;
     ...
     * Gets read_tools
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadTools[]
     */
     ...
     * Sets read_tools
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadTools[] $read_tools Tuning tools which can be used to read this engine.
     *
     * @return $this
     */
     ...
     * Gets read_methods
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadMethods[]
     */
     ...
     * Sets read_methods
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\VdbEngineInfoReadMethods[] $read_methods Method to use when reading this engine.
     *
     * @return $this
     */
