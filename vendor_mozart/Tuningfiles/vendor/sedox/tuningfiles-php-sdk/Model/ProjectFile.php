...
'remap_id' => 'int',
'remap_name' => 'string',
'remap_addons' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\RemapAddon[]',
'size' => 'int',
'md5sum' => 'string',
...
'is_id' => 'bool',
'comment' => 'string',
'pricing' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePricing',
'payment' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePayment',
'added' => '\DateTime',
'updated' => '\DateTime'    ];
...
'updated' => 'getUpdated'    ];
     ...
     * Sets remap_addons
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\RemapAddon[] $remap_addons Array with all special requests (addons) added into the file.
     *
     * @return $this
     */
     ...
     * Gets pricing
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePricing
     */
     ...
     * Sets pricing
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePricing $pricing pricing
     *
     * @return $this
     */
     ...
     * Gets payment
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePayment
     */
     ...
     * Sets payment
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectFilePayment $payment payment
     *
     * @return $this
     */
