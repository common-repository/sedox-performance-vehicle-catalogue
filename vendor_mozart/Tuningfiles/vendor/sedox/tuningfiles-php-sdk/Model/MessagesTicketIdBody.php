...
/**
 * MessagesTicketIdBody Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessagesTicketIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'messages_ticket_id_body';
...
'attachments' => 'getAttachments'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['display_email'] === null) {
            $invalidProperties[] = "'display_email' can't be null";
        }
     ...
     * Sets display_name
     *
     * @param string $display_name Name of the person who wrote the message
     *
     * @return $this
     */
     ...
     * Sets display_email
     *
     * @param string $display_email Email of the person who wrote the message
     *
     * @return $this
     */
