...
/**
 * SupportTicketMessages Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportTicketMessages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'support_ticket_messages';
...
'is_from_staff' => 'bool',
'attachments' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessagesAttachments[]',
'added' => '\DateTime',
'updated' => '\DateTime'    ];
...
'updated' => 'getUpdated'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_from_staff'] = isset($data['is_from_staff']) ? $data['is_from_staff'] : null;
     ...
     * Sets id
     *
     * @param string $id Message ID. UUIDv4 format.
     *
     * @return $this
     */
     ...
     * Sets display_name
     *
     * @param string $display_name Message display name. Name of the person who wrote the message.
     *
     * @return $this
     */
     ...
     * Sets display_email
     *
     * @param string $display_email Message display email. Email of the person who wrote the message.
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getIsFromStaff()
    {
        return $this->container['is_from_staff'];
    }

    /**
     * Sets is_from_staff
     *
     * @param bool $is_from_staff Shows if message was written by the stagff.
     *
     * @return $this
     */
    public function setIsFromStaff($is_from_staff)
    {
        $this->container['is_from_staff'] = $is_from_staff;
     ...
     * Gets attachments
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessagesAttachments[]
     */
     ...
     * Sets attachments
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\SupportTicketMessagesAttachments[] $attachments attachments
     *
     * @return $this
     */
     ...
     * Sets added
     *
     * @param \DateTime $added Date on which message was created
     *
     * @return $this
     */
     ...
     * Sets updated
     *
     * @param \DateTime $updated Date on which message was updated
     *
     * @return $this
     */
