...
/**
 * SupportTicketsBody Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportTicketsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'support_tickets_body';
...
'message_display_email' => 'message_display_email',
'project' => 'project',
...
'subject' => 'setSubject',
'message' => 'setMessage',
'message_display_name' => 'setMessageDisplayName',
'message_display_email' => 'setMessageDisplayEmail',
'project' => 'setProject',
...
'subject' => 'getSubject',
'message' => 'getMessage',
'message_display_name' => 'getMessageDisplayName',
'message_display_email' => 'getMessageDisplayEmail',
'project' => 'getProject',
'attachments' => 'getAttachments'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['message_display_name'] = isset($data['message_display_name']) ? $data['message_display_name'] : null;
        $this->container['message_display_email'] = isset($data['message_display_email']) ? $data['message_display_email'] : null;
     ...
     * Sets department
     *
     * @param int $department ID of the selected department. Obtained from the [/support/departments](#operation/support_list_departments) method.
     *
     * @return $this
     */
     ...
     * Sets subject
     *
     * @param string $subject Brief ticket subject.
     *
     * @return $this
     */
    ...
    /**
     * Gets message_display_name
     *
     * @return string
     */
    public function getMessageDisplayName()
    {
        return $this->container['message_display_name'];
    }

    /**
     * Sets message_display_name
     *
     * @param string $message_display_name Name of the person who wrote the message. If not supplied, system will show the name of the customer instead.
     *
     * @return $this
     */
    public function setMessageDisplayName($message_display_name)
    {
        $this->container['message_display_name'] = $message_display_name;

        return $this;
    }

    /**
     * Gets message_display_email
     *
     * @return string
     */
    public function getMessageDisplayEmail()
    {
        return $this->container['message_display_email'];
    }

    /**
     * Sets message_display_email
     *
     * @param string $message_display_email Email of the person who wrote the message. If not supplied, system will show the email of the customer instead.
     *
     * @return $this
     */
    public function setMessageDisplayEmail($message_display_email)
    {
        $this->container['message_display_email'] = $message_display_email;
     ...
     * Sets project
     *
     * @param int $project ID of the selected project. This parameter is required if department requires a project.
     *
     * @return $this
     */
     ...
     * Sets attachments
     *
     * @param int[] $attachments File attachments. Must be an array with attachment identifiers obtained from the [/support/messages/attachment](#operation/support_upload_attachment) method.
     *
     * @return $this
     */
