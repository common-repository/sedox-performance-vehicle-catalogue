...
/**
 * AttachmentsUpload Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AttachmentsUpload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'attachments_upload';
...
'size' => 'getSize'    ];
     ...
     * Sets id
     *
     * @param int $id ID of the newly uploaded file.
     *
     * @return $this
     */
