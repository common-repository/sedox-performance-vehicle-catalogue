...
/**
 * VdbVehicleType Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VdbVehicleType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vdb_vehicle_type';
...
'icon_url' => 'getIconUrl'    ];
     ...
     * Sets name
     *
     * @param string $name Vehicle type name.
     *
     * @return $this
     */
