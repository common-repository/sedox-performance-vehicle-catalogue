...
/**
 * ProjectRemapData Class Doc Comment
 *
 * @category Class
 * @description Requested remap data.
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProjectRemapData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'project_remap_data';
    ...
    protected static $swaggerTypes = [
        'remap' => 'string',
'remap_id' => 'int',
'addons' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectRemapDataAddons[]'    ];
...
'addons' => 'getAddons'    ];
     ...
     * Sets remap
     *
     * @param string $remap Requested remap.
     *
     * @return $this
     */
     ...
     * Sets remap_id
     *
     * @param int $remap_id Requested remap ID.
     *
     * @return $this
     */
     ...
     * Gets addons
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectRemapDataAddons[]
     */
     ...
     * Sets addons
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\ProjectRemapDataAddons[] $addons Array with all special requests (addons), requested by customer.
     *
     * @return $this
     */
