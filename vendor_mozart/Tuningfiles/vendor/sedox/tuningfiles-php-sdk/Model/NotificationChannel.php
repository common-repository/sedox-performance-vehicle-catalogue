 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationChannel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'notification-channel';
...
self::TYPE_PUSHOVER,        ];
     ...
     * Sets type
     *
     * @param string $type Channel type. Can be: \"email\", \"sms\" and \"pushover\".
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value Value (email, mobile number, Pushover.net ID.
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param bool $active Shows either channel is active or not.
     *
     * @return $this
     */
     ...
     * Sets default
     *
     * @param bool $default Shows either channel is default for this account or not.
     *
     * @return $this
     */
     ...
     * Sets note
     *
     * @param string $note Short comment (note).
     *
     * @return $this
     */
     ...
     * Sets created
     *
     * @param \DateTime $created Date-time when channel was created.
     *
     * @return $this
     */
