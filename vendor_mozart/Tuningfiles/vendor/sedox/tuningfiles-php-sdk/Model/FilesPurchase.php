...
/**
 * FilesPurchase Class Doc Comment
 *
 * @category Class
 * @package  SedoxWPCatalogue\Dependencies\Tuningfiles
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FilesPurchase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'files_purchase';
...
'amount_paid' => 'getAmountPaid'    ];
     ...
     * Sets amount_paid
     *
     * @param int $amount_paid Amount of credits paid for the file.
     *
     * @return $this
     */
