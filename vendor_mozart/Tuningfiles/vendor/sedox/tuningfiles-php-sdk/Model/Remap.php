...
'base_price' => 'int',
'max_tier_price' => 'int',
'addons' => '\SedoxWPCatalogue\Dependencies\Tuningfiles\Model\RemapAddon[]',
'require_addon' => 'bool',
'updated' => '\DateTime'    ];
...
self::VEHICLE_TYPE_ID_5,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['require_addon'] = isset($data['require_addon']) ? $data['require_addon'] : null;
     ...
     *
     * @param int $vehicle_type_id ID of the vehicle type. 1 - Cars & LCV, 2 - Trucks & Buses, 3 - Agriculture, 4 - Marine, 5 - Motorcycles & ATVs
     *
     * @return $this
     */
     ...
     * Gets addons
     *
     * @return \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\RemapAddon[]
     */
     ...
     * Sets addons
     *
     * @param \SedoxWPCatalogue\Dependencies\Tuningfiles\Model\RemapAddon[] $addons Special requests (addons) available for this remap.
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getRequireAddon()
    {
        return $this->container['require_addon'];
    }

    /**
     * Sets require_addon
     *
     * @param bool $require_addon Indicates if this remap type requires at least one addon to be selected.
     *
     * @return $this
     */
    public function setRequireAddon($require_addon)
    {
        $this->container['require_addon'] = $require_addon;
