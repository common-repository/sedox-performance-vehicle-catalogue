...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.tuningfiles.com/';
     ...
     * @var string
     */
    protected $userAgent = 'TuningFiles-API/1.2.2/php';
    ...
    {
        $report  = 'PHP SDK (Tuningfiles) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.2.3' . PHP_EOL;
